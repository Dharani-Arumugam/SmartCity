...
#Defining the coordinates for london and birmingham
LONDON_COORDINATES = {"latitude": 51.5074, "longitude": -0.1278}
BIRMINGHAM_COORDINATES = {"latitude": 52.4862, "longitude": -1.8904}

#Calculate movement increments
# Divide the whole journey into 100 steps to simulate 100 events to Kafka
LATITUDE_INCREMENT = (BIRMINGHAM_COORDINATES["latitude"] - LONDON_COORDINATES["latitude"])/100
LONGITUDE_INCREMENT = (BIRMINGHAM_COORDINATES["longitude"] - LONDON_COORDINATES["longitude"])/100

print(LATITUDE_INCREMENT, LONGITUDE_INCREMENT)
...
#setting the random seed to get same output every run
random.seed(42)
...
def generate_vehicle_data(device_id):
    ...
    #Add some randomness to simulate actual road data
...
def delivery_report(err, msg):
    if err is not None:
        ...
        print(f"Delivery report success: {msg.topic()}[{msg.partition()}]")
...
if __name__ == "__main__":
    ...
    # Simulate data for the whole journey of vehicle from London to Birmingham
    try:
        simulate_journey(producer, 'Vehicle-dharani')
    except KeyboardInterrupt:
        print('Simulation ended by User')
    except Exception as err:
        print(f'Simulation ended by Exception: {err}')
